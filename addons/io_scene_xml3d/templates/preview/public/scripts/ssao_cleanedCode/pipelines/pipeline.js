...
//        },
    ...
    function readBackFrameBuffer(renderInterface, algorithm) {
        ...
        img.onload = function () {
            var formData = {frame: algorithm, data: img.src};
            $.ajax({
    ...
    window.addEventListener("load", function () {
        ...
        var algorithmIdx = 0;
        var algorithms = ["starcraft"];
        xml3dElement.addEventListener("load", function () {
            console.log("model loaded");
            xml3dElement.addEventListener("framedrawn", function readBackImageForEachAlgorithm() {
                if (algorithms[algorithmIdx - 1] != null) {
                    readBackFrameBuffer(renderInterface, algorithms[algorithmIdx - 1]);
                }
                if (algorithmIdx < algorithms.length) {
                    window.ssao_type = algorithms[algorithmIdx];
