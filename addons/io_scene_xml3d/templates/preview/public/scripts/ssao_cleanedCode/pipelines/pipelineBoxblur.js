    ...
    XML3D.extend(MySSAORenderTree.prototype, {
        ...
        createMainPass: function () {
            ...
            if (this._enableSSAO) {
                ...
                var boxBlurPass = this.createBlurPass(ssaoPass.output);
                boxBlurPass.addPrePass(ssaoPass);
                this._blurPass = boxBlurPass;
                ...
                this.mainPass = new webgl.ForwardRenderPass(this.renderInterface, outputTarget, {
                    inputs: {
                        ssaoMap: boxBlurPass.output
                    }
                });
                this.mainPass.addPrePass(boxBlurPass);
            } else {
                this.mainPass = new webgl.ForwardRenderPass(this.renderInterface, outputTarget);
            }
...
//        },
        ...
        createBlurPass: function (inputBuffer) {
            ...
            return new webgl.BoxBlurPassPipeline(this.renderInterface, blurBuffer, {
                inputs: {
                    buffer: inputBuffer
                }
            });
